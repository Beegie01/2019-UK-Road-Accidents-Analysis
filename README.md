...
My goal was to extract sufficient knowledge from the data through analyses and pattern mining techniques, and use this knowledge to build a predictive model that can assist government officials in making precautionary policies to prevent enabling conditions for road accidents.<br>
